  ...
  return (
    ...
    <div className="container mx-auto py-20">
      ...
      {services.map((service, index) => (
        <Link href="/OtherServices" key={index} className=" rounded-lg py-10 items-center flex bg-[#EBF1F4] text-textSecondary font-normal">
    ...
    <div className="bg-[#EBF1F4] md:p-10 p-2 mb-10">
        <div className="container mx-auto flex flex-col md:flex-row gap-4 items-center justify-center">
            <div className="md:w-9/12 w-full">
                 <h1 className="font-medium 2xl:text-3xl text-colorThemeDarkVariant mb-6">Don’t Miss Our News !</h1>
                 ...
                 <div className="text-center 2xl:text-lg text-colorThemelightVariant font-bold mt-5 md:w-1/2 w-full">
                    <h1>Subscribe Now &gt; &gt; &gt;</h1>
                </div>
                </div>
