...
const Footer = () => {
  return (
    <footer className=" py-8 bg-colorThemePrimary">
      <div className="container mx-auto flex flex-wrap items-start justify-start py-12 border-borderColor  border-b-2 text-MainColor">
      <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/6  mb-8 relative">
          {/* <img src="/images/logo.png" alt="Logo" className="w-20 h-20" /> */}
          <h1 className='md:block -rotate-90 absolute text-white text-5xl top-10 -left-10 hidden'>DIRISE</h1>
        </div>
